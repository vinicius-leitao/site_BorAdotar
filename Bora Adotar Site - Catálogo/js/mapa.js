(function(){
    ...
    if(container) {  //Verificando se o usuário está logado. O mapa exibirá a partir do ponto mais proximo dele. Caso não esteja, exibirá uma coordenada padrão do Rio de Janeiro; 
        axios.get("http://localhost:3000/catalogo").then(response => {
        let user = JSON.parse(response.headers.cookie)
